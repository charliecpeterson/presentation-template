...
::: {.callout-tip appearance="simple"}
### Why this beats splitting the code
The audience keeps the whole block in view while you spotlight one part at a time.
:::
...
::: {.scroll-box .short}
```bash
# Wrap any long code/text block in ::: {.scroll-box} ... :::
# Height variants: .tall (600px), default (460px), .short (340px), .shorter (265px).
# For rendered markdown instead of a code fence, use .scroll-box.prose.
# This block is intentionally long so the branded scrollbar appears.
